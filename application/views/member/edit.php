...
<title>Edit <?php echo $mem['fullname']; ?> || School</title>
				...
				<div class="forms">
					<div class="row">
						<div class="form-three widget-shadow">
							<h3 class="h3-title">Edit <?php echo $mem['fullname']; ?> Members</h3>
							<form class="form-horizontal" action="<?php echo base_url('member/edit/'.$mem['id']); ?>" method="post">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="fullname" placeholder="Full Name" value="<?php echo $mem['fullname']; ?>">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="email" placeholder="Email Address" value="<?php echo $mem['email']; ?>">
