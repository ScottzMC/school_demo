				...
				<div class="forms">
					<div class="row">
						<div class="form-three widget-shadow">
							<h3 class="h3-title">Add School</h3>
							<form class="form-horizontal" action="<?php echo base_url('school/add'); ?>" method="post" enctype="multipart">
								<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">School</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="school_name" placeholder="School">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="county" placeholder="County">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="city" placeholder="City">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="postcode" placeholder="Postcode">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="date" class="form-control1" name="registered_at" placeholder="dd-mm-yyyy">
										<span class="text-danger" style="color: red;"><?= form_error('registered_at'); ?></span>
									</div>
								</div>
